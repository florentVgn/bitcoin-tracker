...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/hOSEA3Py8F)
...
```sh
npx nx serve bitcoin-wallet-tracker
```

To create a production bundle:

```sh
npx nx build bitcoin-wallet-tracker
```

To see all available targets to run for a project, run:

```sh
npx nx show project bitcoin-wallet-tracker
```
